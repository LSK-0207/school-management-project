...
-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_assingmentId_fkey" FOREIGN KEY ("assingmentId") REFERENCES "Assignement"("id") ON DELETE SET NULL ON UPDATE CASCADE;
